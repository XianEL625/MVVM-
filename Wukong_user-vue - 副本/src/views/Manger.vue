<template>
    <div>
        <!-- 头部开始 -->
         <div style="height: 60px;background-color: rgb(0,0,0);display: flex;align-items: center;">
    ...
    <!-- 头部结束 -->
     ...
     <div style="display: flex; flex: 1;">
      <!-- Sidebar -->
      <div  v-if="['/Manger/Community', '/Manger/Composition', '/Manger/HomeView', '/Manger/Work'].includes($route.path)" style="width: 200px; border-right: 1px solid rgb(194, 176, 231, 1); min-height: 100vh; background-color: #0000;">
        <el-scrollbar style="height: 100vh;">
          <el-menu router style="border: 0;" :default-openeds="['1']">
            <!-- <el-menu-item index="/Manger/homeview" style="display: block; text-align: center; padding: 0 70px 0 0px;">首页</el-menu-item> -->
            <el-sub-menu index="1">
              <el-menu-item-group>
                <el-menu-item index="/Manger/discover">发现</el-menu-item>
                <el-menu-item index="/Manger/publish">发布</el-menu-item>
                <el-menu-item index="/Manger/notification">通知</el-menu-item>
              </el-menu-item-group>
            </el-sub-menu>
          </el-menu>
        </el-scrollbar>
    ...
    <script setup>
     ...
     const data=reactive({
       account: JSON.parse(localStorage.getItem("account"))|| { role: '', username: '' },
