    ...
    <div>
        <!-- 头部开始 -->
         <div style="height: 60px;background-color: rgb(113,73,213);display: flex;align-items: center;">
          <div style="width: 200px;font-family: 宋体;display: flex; align-items: center;">
            <img style="width: 40px;padding-left: 15px;" src="../assets/logo.png" alt="" >
          <span style="font-size:20px; color:white">医院挂号系统</span>
          </div>
    ...
    <!-- 头部结束 -->
     ...
     <!-- 下面部分开始 -->
      <div style="display: flex;flex:1;">
        <!-- 左侧导航菜单开始 -->
        <div style="width:200px;border-right: 1px solid rgb(194,176,231,1); min-height:100vh;">
          <el-scrollbar>  
