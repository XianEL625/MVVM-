    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="商圈类型" align="center" prop="businessDistrictType">
        <template #default="scope">
          <dict-tag :options="business_district_type" :value="scope.row.businessDistrictType"/>
        </template>
      </el-table-column>
      <el-table-column label="合作商" align="center" prop="partner.partnerName" />
      <el-table-column label="详细地址" align="left" prop="addressDetail" show-overflow-tooltip="true" />
      ...
      <el-form ref="nodeRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="商圈类型" prop="businessDistrictType">
          <el-select v-model="form.businessDistrictType" placeholder="请选择商圈类型">
            <el-option
              v-for="dict in business_district_type"
              :key="dict.value"
              :label="dict.label"
...
const { business_district_type } = proxy.useDict('business_district_type');
