<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300px">
        <template #default="scope">
          <el-button link type="primary"  @click="restPwd(scope.row)" v-hasPermi="['manage:partner:edit']">重置密码</el-button>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="partnerRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="分成比例" prop="share_ratio">
  ...
  <el-row :gutter="20">
    <el-col :span="12">
      合作商名称：{{ form.partnerName }}
    </el-col>
    <el-col :span="12">
      联系人：{{ form.contactPerson }}
    </el-col>
  </el-row>
  <el-row :gutter="20">
    <el-col :span="12">
